...
const properties = [
  {
    ...
    amenities: [
      ...
      { name: "Swimming Pool", icon: "pool", available: false },
      { name: "Air Conditioning", icon: "air-conditioning", available: true },
    ],
  ...
  },
  {
    ...
    hasvideo: true,
    amenities: [
      { name: "Gym", icon: "gym", available: false },
      { name: "Pet Friendly", icon: "pets", available: true },
      { name: "Laundry", icon: "laundry", available: true },
    ],
  ...
  },
  {
    ...
    amenities: [
      ...
      { name: "Air Conditioning", icon: "air-conditioning", available: true },
      { name: "Gym", icon: "gym", available: false },
      { name: "Pet Friendly", icon: "pet friendly", available: true },
      { name: "Laundry", icon: "laundry", available: true },
      { name: "Balcony", icon: "balcony", available: false },
      { name: "Elevator", icon: "elevator", available: true },
      { name: "Security", icon: "security", available: true },
